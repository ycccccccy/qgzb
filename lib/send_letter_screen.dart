  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      ...
      child: Scaffold(
          ...
          body: Material(
            child: Padding(
              // Padding applied directly under Material
              padding: EdgeInsets.all(isMobile ? 16 : 32),
              child: Form(
                key: _formKey,
                child: SingleChildScrollView(
                  child: Column(
                    // Main layout is Column
                    crossAxisAlignment: CrossAxisAlignment.stretch,
                    children: [
                      Row(
                        // Receiver Name Input and Search Icon
                        children: [
                          Expanded(
                            child: TextFormField(
                              ...
                              onChanged: (value) {
                                // Trigger debounce search on input change
                        ...
                        LayoutBuilder(
                          builder: (context, constraints) {
                            ...
                            if (_searchResults.length == 1) {
                              ...
                              calculatedHeight =
                                  _searchResults.length * itemHeight > maxListHeight
                                      ? maxListHeight
                      ...
                      else if (_receiverNameController.text.isNotEmpty &&
                          !_isSearching &&
                          _showNoResultTip)
                        // Show "No Result" tip when no results and conditions met
                        Container(
                      ...
                      AnimatedOpacity(
                        // Selected Search Result Info Card (remains unchanged)
                      ...
                      if (_isSearchResultSelected)
                        // Cancel Selected Result Button (remains unchanged)
                        Align(
                      ...
                      if (!_isSearchResultSelected)
                        // District and School Dropdowns (remains unchanged)
                        Column(
                          children: [
                      ...
                      const SizedBox(height: 12),
                      if (!_isSearchResultSelected)
                        // Specify Class Checkbox (remains unchanged)
                        Row(
                          children: [
                            Checkbox(
                      ...
                      const SizedBox(height: 12),
                      // Increased spacing for class selectors (remains unchanged)
                      AnimatedSize(
                          // Grade and Class Number Dropdowns (remains unchanged)
                          duration: const Duration(milliseconds: 300),
                          child: !_isSearchResultSelected && _isSpecificClass
                              ? ClipRect(
                                  child: Row(
                                    children: [
                                      Expanded(
                      ...
                      const SizedBox(height: 12),
                      buildTextFormField(
                        // Letter Content Input (remains unchanged)
                      ...
                      const SizedBox(height: 12),
                      Row(
                        // Anonymous Send Checkbox (remains unchanged)
                        children: [
                          Checkbox(
                            value: _isAnonymous,
                            onChanged: (value) {
